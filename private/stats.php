...
<body class="bg-light">
    <div class="container py-4">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12">
                <?php if (empty($pages_par_annee)): ?>
                    <p>Aucune donnée de pages lues disponible.</p>
                <?php else: ?>
                    <h2>Pages lues par année et mois <?php foreach ($pages_par_annee as $annee => $moisArray): ?>
                            <?= htmlspecialchars($annee) ?></h2>
                    <ul class="list-group mb-3">
                        <?php foreach ($moisArray as $moisNum => $total):
                                                                $affichageMois = formatMois($annee, $moisNum);
                        ?>
                            <li class="list-group-item d-flex justify-content-between">
                                <span class="flex-grow-1"><?= htmlspecialchars($affichageMois) ?></span>
