...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 28 juin 2025 à 13:49
...
(28, 'Alex Flinn', 'Beastly', '', '', '', '978-0-061-99866-9', 'BOOK', 0.00, '', '0000-00-00', '0000-00-00', '', '', 'A beast. Not quite wolf or bear, gorilla or dog but a horrible new creature who walks upright—a creature with fangs and claws and hair springing from every pore. I am a monster. You think I\'m talking fairy tales? No way. The place is New York City. The ti', 'Harper Collins', '343', '', 'Juvenile Fiction', 'http://books.google.com/books/content?id=7xJKxbP5pL0C&printsec=frontcover&img=1&zoom=1&source=gbs_api', ''),
(29, 'Rebecca Yarros', 'Onyx Storm - Version française', '', '', '', '9782755673104', 'BOOK', 0.00, '2025-06-18', '2025-06-27', '0000-00-00', '', '', 'AFFRONTER LES TÉNÈBRES La guerre prend un tournant massif mais le plus grand risque vient désormais de l\'intérieur. Plus amoureuse que jamais, Violet est bien décidée à affronter les ténèbres.', 'Hugo Roman', '766', '', 'Fiction', 'http://books.google.com/books/content?id=-yU9EQAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', ''),
(30, 'Rebecca Yarros', 'Onyx Storm', '', '', '', '9789510514993', 'BOOK', 0.00, '', '0000-00-00', '0000-00-00', '', '', 'Brave the dark. Get ready to fly or die in the breathtaking follow-up to Fourth Wing and Iron Flame from the no. 1 Sunday Times and New York Times bestselling author Rebecca Yarros. Returning to the richly imagined world of Fourth Wing and Iron Flame, the', 'WSOY', '626', '', 'Fiction', 'http://books.google.com/books/content?id=cYwdEQAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', '');
